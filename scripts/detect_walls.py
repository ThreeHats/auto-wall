...
def main(input_image_path, output_image_path, min_contour_area=100, blur_kernel_size=5, canny_threshold1=50, canny_threshold2=150, show_result=True):
