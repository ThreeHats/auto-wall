...
def process_image(image_path, min_contour_area=100, max_contour_area=None, blur_kernel_size=5, canny_threshold1=50, canny_threshold2=150):
...
def main(input_image_path, output_image_path, min_contour_area=100, max_contour_area=None, blur_kernel_size=5, canny_threshold1=50, canny_threshold2=150, show_result=True):
    """Main function to detect walls in an image and save/show the result."""
    # Process the image
    result_image = process_image(input_image_path, min_contour_area, max_contour_area, blur_kernel_size, canny_threshold1, canny_threshold2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max-area', '-M', type=int, default=None, help='Maximum contour area (None means no upper limit)')
    ...
    main(args.input, args.output, args.min_area, args.max_area, args.blur, args.canny1, args.canny2)